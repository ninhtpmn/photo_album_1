        ...
        switch(item.getItemId())
        {
            ...
            case R.id.setbg:
                ...
                try {
                    ...
                    Toast.makeText(this,
                            R.string.noti_setwallpaper, Toast.LENGTH_SHORT)
                            .show();
                } catch (IOException e) {
                    e.printStackTrace();
                }
            ...
            case R.id.delete:
                ...
                if(!new File(path).exists()) {
                    Toast.makeText(this, R.string.deleteok, Toast.LENGTH_SHORT).show();
                ...
                else Toast.makeText(this, R.string.deletefail, Toast.LENGTH_SHORT).show();
